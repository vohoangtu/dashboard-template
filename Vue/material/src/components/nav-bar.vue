    ...
    <div class="layout-width">
      <div class="navbar-header">
        ...
        <div class="d-flex align-items-center">
          <BDropdown class="dropdown d-md-none topbar-head-dropdown header-item shadow-none" variant="ghost-secondary" dropstart
          ...
          <BDropdown variant="ghost-secondary" dropstart :offset="{ alignmentAxis: 57, crossAxis: 0, mainAxis: -42 }"
            class="ms-1 dropdown" toggle-class="btn-icon btn-topbar rounded-circle mode-layout arrow-none shadow-none"
              ...
              <div class="p-2">
                ...
                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2"
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-2">
                      <button type="button" class="btn btn-ghost-secondary btn-sm btn-icon remove-item-btn shadow-none"
