                ...
                <div>
                  ...
                  <div class="d-flex flex-wrap gap-2 select-color">
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="Out of Stock">
                      <button type="button"
                        class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-primary"
                        disabled>
                    ...
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <button type="button"
                        class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-secondary">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </button>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <button type="button"
                        class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-success">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </button>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="02 Items Available">
                      <button type="button"
                        class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-info">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </button>
                    </div>
                  </div>
