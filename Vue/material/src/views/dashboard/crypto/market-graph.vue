  ...
  <BCard no-body>
    <BCardHeader class="border-0 align-items-center d-flex">
      ...
      <div class="hstack gap-1">
        <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">1H</BButton>
        <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">7D</BButton>
        <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">1M</BButton>
        <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">1Y</BButton>
        <BButton type="button" variant="soft-primary" size="sm" class="shadow-none">ALL</BButton>
      </div>
    </BCardHeader>
    <BCardBody class="p-0">
