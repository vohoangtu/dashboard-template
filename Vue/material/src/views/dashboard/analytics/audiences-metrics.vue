  ...
  <BCard no-body>
    <BCardHeader class="border-0 align-items-center d-flex">
      ...
      <div class="hstack gap-1">
        <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">ALL</BButton>
        <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">1M</BButton>
        <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">6M</BButton>
        <BButton type="button" variant="soft-primary" size="sm" class="shadow-none">1Y</BButton>
      </div>
    </BCardHeader>
