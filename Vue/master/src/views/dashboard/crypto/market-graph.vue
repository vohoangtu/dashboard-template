  ...
  <BCard no-body>
    <BCardHeader class="border-0 align-items-center d-flex">
      ...
      <div class="hstack gap-1">
        <BButton type="button" variant="soft-secondary" class="material-shadow-none" size="sm">1H</BButton>
        <BButton type="button" variant="soft-secondary" class="material-shadow-none" size="sm">7D</BButton>
        <BButton type="button" variant="soft-secondary" class="material-shadow-none" size="sm">1M</BButton>
        <BButton type="button" variant="soft-secondary" class="material-shadow-none" size="sm">1Y</BButton>
        <BButton type="button" variant="soft-primary" class="material-shadow-none" size="sm">ALL</BButton>
      </div>
    </BCardHeader>
    <BCardBody class="p-0">
