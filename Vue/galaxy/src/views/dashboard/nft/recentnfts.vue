                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <router-link to="/apps/nft-item-detail">Abstract Face
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <router-link to="/apps/nft-item-detail">Robotic Body
                                                Art</router-link>
                                        </h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <router-link to="/apps/nft-item-detail">Smillevers
                                                Crypto</router-link>
                                        </h6>
                                        <p class="text-muted mb-0">Artworks</p>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <router-link to="/apps/nft-item-detail">Creative
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <router-link to="/apps/nft-item-detail">The
