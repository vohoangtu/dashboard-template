    ...
    return {
      ...
      chartOptions: {
        ...
        colors: getChartColorsArray(
          '["--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4", "--vz-primary-rgb, 0.4"]'
        ),
        dataLabels: {
          enabled: true,
          offsetX: 32,
