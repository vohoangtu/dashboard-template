              ...
              <BCol lg class="border-end">
                <div class="mt-3 mt-lg-0 py-4 px-3">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <h2 class="mb-0">
                        $<count-to :startVal="0" :endVal="1596.5" :duration="5000" :decimals="1"></count-to>0
                      </h2>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-info-subtle rounded-circle fs-2">
                    <UsersIcon class="text-info material-shadow"></UsersIcon>
                  </span>
                </div>
              </div>
            </div>
      ...
      <BCol xxl="5">
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <BDropdown variant="link" right toggle-class="text-decoration-none p-0" class="card-header-dropdown" no-caret>
                <template #button-content> <span class="text-muted fs-18"><i class="mdi mdi-dots-vertical"></i></span>
                </template>
            ...
            <BCol lg="6">
              <BCardBody class="text-center">
                ...
                <div class="d-flex gap-2 justify-content-center mb-3">
                  <button type="button" class="btn avatar-xs p-0 material-shadow-none" v-b-tooltip.hover title="Google">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-google-line"></i>
                    </span>
                  </button>

                  <button type="button" class="btn avatar-xs p-0 material-shadow-none" v-b-tooltip.hover title="Linkedin">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-linkedin-line"></i>
                    </span>
                  </button>
                  <button type="button" class="btn avatar-xs p-0 material-shadow-none" v-b-tooltip.hover title="Dribbble">
                    <span class="avatar-title rounded-circle bg-light text-body">
