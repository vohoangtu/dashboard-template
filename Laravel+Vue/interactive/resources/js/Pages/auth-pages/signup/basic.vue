                            ...
                            <BCardBody class="p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidate>
                                        ...
                                        <div class="mb-4">
                                            <p class="mb-0 fs-13 text-muted fst-italic">By registering you agree to the
                                                Velzon <BLink href="#" class="text-primary text-decoration-underline fst-normal fw-semibold">
                                                    Terms
                                                    of Use</BLink>
                                            </p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <BButton variant="info" class="w-100" type="button">Sign
                                                Up</BButton>
                                        </div>
