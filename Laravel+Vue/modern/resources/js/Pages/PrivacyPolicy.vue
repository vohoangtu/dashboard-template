                    ...
                    <BCardBody class="p-4">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted">At Website Name, accessible at Website.com, one of our main priorities
                                    is the
                                ...
                                <p class="text-muted">This privacy policy applies only to our online activities and is valid
                                    for
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted">Communicate with you, either directly or through one of our partners,
                                    including
                                    for customer service, to provide you with updates and other information relating to the
                                    website, and
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <p class="text-muted">Some of advertisers on our site may use cookies and web beacons. Our
                                    ...
                                    below.</p>
                                <p class="text-muted"><b>Website Name's Privacy Policy does not apply to other advertisers
                                        or websites.
