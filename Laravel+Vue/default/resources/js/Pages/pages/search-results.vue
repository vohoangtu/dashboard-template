    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
                ...
                <BRow class="g-2">
                  <BCol>
                    <div class="position-relative mb-3">
                      ...
                      <BLink class="btn btn-link link-success btn-lg position-absolute end-0 top-0" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><i class="ri-mic-fill"></i></BLink>
                    </div>
                  </BCol>
                  <div class="col-auto">
          ...
          <BCardBody class="p-4">
            <BDropdown variant="transparent" right toggle-class="arrow-none" class="fw-medium text-reset mb-n1" no-caret style="position: absolute; right: 2px;">
