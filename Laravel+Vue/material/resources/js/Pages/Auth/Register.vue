                                    ...
                                    <form @submit.prevent="submit" class="needs-validation" novalidate>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                ...
                                                <BButton variant="link" class="position-absolute end-0 top-0 text-decoration-none text-muted password-addon shadow-none" type="button" @click="togglePassword = !togglePassword"><i class="ri-eye-fill align-middle"></i></BButton>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                ...
                                                <BButton variant="link" class="position-absolute end-0 top-0 text-decoration-none text-muted password-addon shadow-none" type="button" @click="togglePassword_conf = !togglePassword_conf"><i class="ri-eye-fill align-middle"></i></BButton>
