                                    ...
                                    <div class="p-lg-5 p-4">
                                            ...
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        ...
                                                        <BButton variant="link" class="position-absolute end-0 top-0 text-decoration-none shadow-none text-muted" type="button" id="password-addon" @click="togglePassword = !togglePassword"><i class="ri-eye-fill align-middle"></i></BButton>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Don't have an account ?
                                                <Link href="/auth/signup-cover" class="fw-semibold text-primary text-decoration-underline"> Signup
                                                </Link>
                                            </p>
                                        </div>
                                    </div>
