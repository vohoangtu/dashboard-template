                                    ...
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form class="needs-validation" novalidate>
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-13 text-muted fst-italic">By registering you agree
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Already have an account ? <Link href="/auth/signin-cover" class="fw-bold text-primary text-decoration-underline"> Signin
                                                </Link>
                                            </p>
                                        </div>
                                    </div>
